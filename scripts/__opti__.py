...
def monteCarlo(nbIteration, log=False) :
    """
    ...
    This use multiprocessing to accelerate the process.
    ...
    # We start the a multiprocessing executor to accelerate the process
